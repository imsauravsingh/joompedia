...
var datepickr = (function() {
		...
		calendarClick: function(e) {
			if(e.target.className) {
				switch(e.target.className) {
					...
					case 'next-month':
					case 'nextMonth':
					case 'ico ico-go-to-arrow-right':
						this.currentMonthView++;
	...
	function buildMonths(config, currentMonthView, currentYearView) {
		...
		prevMonth = buildNode('span', { className: 'prev-month' }, buildNode('span', { className: 'ico ico-go-to-arrow-left' })),
		nextMonth = buildNode('span', { className: 'next-month' }, buildNode('span', { className: 'ico ico-go-to-arrow-right' }));
