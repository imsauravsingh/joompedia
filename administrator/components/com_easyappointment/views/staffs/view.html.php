...
class EasyappointmentViewStaffs extends JViewLegacy
{
	protected $items;
	...
	public function addToolbar() {	
		...
		JToolBarHelper::title(   'EasyAppointment :: ' . JText::_( 'COM_EASYAPPOINTMENT_STAFF' ), 'staffs' );
		...
		if ($canDo->get('core.delete')) {
			JToolBarHelper::custom('staffs.delete', 'delete.png', 'delete.png', 'JTOOLBAR_DELETE' , true);
		}
