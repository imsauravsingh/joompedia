...
require_once JPATH_CONFIGURATION.'/administrator/components/com_easyappointment/helpers/services.php';

class JFormFieldJmenuservice extends JFormFieldList {

	public function getInput() 
	{	
		$html = '<select name="'.$this->name.'" class="'.$this->element['class'].'">';	
		$html .= '<option value="0">'.JText::_('COM_EASYAPPOINTMENT_ROOT').'</option>';
