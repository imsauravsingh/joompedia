...
class EasyappointmentViewInformation extends JViewLegacy
{	
	protected $form;
	protected $user;
	protected $service;
	...
	{	
		...
		JHtml::script( 'components/com_easyappointment/assets/js/views/information.js' );
	}
